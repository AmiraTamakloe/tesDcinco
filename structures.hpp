...
public:
	...
	virtual void afficherInfoPrimaireSur(ostream& os) const = 0;
...
public:
	...
	// bool operator<(Item* Item1, Item* Item2) const {return Item1->titre < Item2->titre ;}
...
public:
	...
	void afficherInfoPrimaireSur(ostream& os) const override;
	void afficherLesActeurs(ostream& os) const;
